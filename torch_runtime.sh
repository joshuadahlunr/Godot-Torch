...
CAFFE2_ROOT="$( cd "$(dirname "$0")"/thirdparty/pytorch ; pwd -P)"
...
CMAKE_ARGS+=("-DBUILD_PYTHON=OFF") # new
...
CMAKE_ARGS+=("-DUSE_BLAS=ON")
# CMAKE_ARGS+=("-DUSE_KINETO=OFF") # new
...
BUILD_ROOT=${BUILD_ROOT:-"$CAFFE2_ROOT/runtime"}
